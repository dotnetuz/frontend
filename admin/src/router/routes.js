...
export default [
  ...
  {
    path: "/applicant-interviewer",
    name: "Interviewer list",
    meta: {
      authRequired: true,
    },
    component: () => import("../views/Applicant/interviewers"),
  },
  {
    ...
    component: () => import("../views/Applicant/calendar"),
  },
  {
    ...
    component: () => import("../views/Applicant/history"),
  },
  // !
  {
    path: "/interviewer-request",
    name: "interviewer-request",
    meta: {
      authRequired: true,
    },
    component: () => import("../views/Interviewer/Request"),
  },
  // !
  {
    path: "/hr",
