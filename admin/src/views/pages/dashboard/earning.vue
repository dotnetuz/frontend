...
<template>
  <div class="card">
    <div class="card-body">
      ...
      <h4 class="card-title mb-4">Suhbatdan o'tish darajasi</h4>
        ...
        <div class="row">
          <div class="col-sm-6">
            <div>
              ...
              <p class="text-muted text-truncate mb-2">O'ratacha daraja</p>
              <h5 class="mb-0">6.7</h5>
            </div>
          </div>
