...
import {
  calendarEvents,
  categories,
} from "@/views/pages/calendar/data-calendar";
  ...
  methods: {
    ...
    editEvent(info) {
      ...
      this.editevent.editTitle =
        "https://us02web.zoom.us/j/81474753663?pwd=Yzd0UWVSVk0wWEwxK0hEcVlaUk5jQT09";
    ...
    >
      <form @submit.prevent="editSubmit">
        ...
        <div class="text-right p-3">
          <b-button variant="danger" @click="closeModal">Yopish</b-button>
          <a
            href="https://us02web.zoom.us/j/81474753663?pwd=Yzd0UWVSVk0wWEwxK0hEcVlaUk5jQT09"
            target="_blank"
          >
            <b-button class="ml-2" variant="info" @click="closeModal"
              >O'tish</b-button
            >
          </a>
        </div>
